...
<head>
   ...
   <link rel="shortcut icon" href="<?php echo base_url(); ?>ubold/assets/images/favicon_1.ico">
    ...
    <title>E-Room PNM | Administrator</title>
    ...
    <div class="topbar">
                ...
                <div class="topbar-left">
                    <div class="text-center">
                        <a href="<?php echo base_url('peminjaman'); ?>" class="logo">
                            E-Room</span></a>
                        <!-- Image Logo here
                        <a href="index.html" class="logo">
                            <i class="icon-c-logo"> <img src="<?php echo base_url(); ?>ubold/assets/images/users/eroom_logo.png" height="42"/> </i>
                            <span><img src="<?php echo base_url(); ?>ubold/assets/images/users/eroom_logo.png" height="20"/></span>
                        </a> -->
                    </div>
                </div>
                        ...
                        <div class="">
                            ...
                            <ul class="nav navbar-nav navbar-right pull-right">
                                ...
                                <li class="dropdown top-menu-item-xs">
                                    <a href="#" class="dropdown-toggle profile waves-effect waves-light" data-toggle="dropdown" aria-expanded="true"><img src="<?php echo base_url(); ?>ubold/assets/images/users/eroom_logo.png" alt="user-img" class="img-circle"> </a>
                                </li>
                            </ul>
                        </div>
                        <!--/.nav-collapse -->
                ...
                <div class="sidebar-inner slimscrollleft">
                    ...
                    <div id="sidebar-menu">
                        <ul>
                            ...
                            <li class="has_sub">
                                <a href="<?php echo base_url('peminjaman'); ?>" class="waves-effect"><i class="ti-home"></i> <span> Peminjaman </span></a>
                            </li>
